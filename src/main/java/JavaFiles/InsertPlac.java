 ...
 */
@WebServlet("/insertPlacement")
public class InsertPlac extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // Commented-out PreparedStatement code removed
            ...
            out.println("<!DOCTYPE html>\r\n"
            		...
            		+ "          <h1></h1>\r\n "
            		+ "<p>...</p>"
            		+ "          <p><strong>Edited details.</strong></p>\r\n"
            		+ "  <p>Check your database</p>\r\n"
            		+ "<p> click here to go to <a href='homePage.html' target='-blank'>home page.</a>"
            		+ "        </div>\r\n"
            		+ "      </div>\r\n"
            		+ "    </article></body>\r\n"
            		+ "</html>");
