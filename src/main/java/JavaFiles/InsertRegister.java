...
PreparedStatement st = con.prepareStatement("insert into registertb2 values(?,?,?,?,?,?,?,?,?)");
...
st.setString(5, request.getParameter("roll"));
...
st.setString(9, request.getParameter("confirm_password"));
st.executeUpdate();
