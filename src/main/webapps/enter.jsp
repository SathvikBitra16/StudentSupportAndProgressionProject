...
<div class="student-block">
    <p><strong>REGISTER ID:</strong> <%=resultSet.getString("ROLLNUMBER") %></p>
    <p><strong>NAME:</strong> <%=resultSet.getString("Name") %></p>
    <p><strong>TYPE OF THE BUSINESS:</strong> <%=resultSet.getString("TypeBusiness") %></p>
    <p><strong>NAME OF THE BUSINESS:</strong> <%=resultSet.getString("NameBusiness") %></p>
    <p><strong>PAN/ TAN NUMBER:</strong> <%=resultSet.getString("PanNo") %></p>
