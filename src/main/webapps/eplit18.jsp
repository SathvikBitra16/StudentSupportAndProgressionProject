...
<%
String rno = request.getParameter("rno");String driver = "oracle.jdbc.driver.OracleDriver";
...
<div class="student-block">
    <div class="form-group">
        ...
        <p><%=resultSet.getString("REGISTERID") %></p>
    </div>
    <div class="form-group">
...
<div class="submit-container">
    <form action="http://localhost:8080/MiniProject/insertPlacement" method="post">
