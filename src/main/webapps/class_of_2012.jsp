...
<div class="head">
<h2><span class="circle">2012</span> > Select Programme/Course/Department</h2>

<h3>Bachelor of Technology (B. Tech)</h3></div>
<div class="container">
  <div class="card">
    <h2><a href="cse.jsp"><button class="login-button">Computer Science and Engineering - CSE</button></a></h2>
    <p>240 Members</p>
  </div>
  <div class="card">
    <h2><a href="it.jsp"><button class="login-button">Information Technology - IT</button></a></h2>
    <p>118 Members</p>
  </div>
  <div class="card">
    <h2><a href="mech.jsp"><button class="login-button">Mechanical Engineering - MECH</button></a></h2>
    <p>51 Members</p>
  </div>
  <div class="card">
    <h2><a href="ece.jsp"><button class="login-button">Electronics and Communication Engineering - ECE</button></a></h2>
    <p>34 Members</p>
  </div>
  <div class="card">
    <h2><a href="civ.jsp"><button class="login-button">CIVIL Engineering - CIV</button></a></h2>
    <p>60 Members</p>
  </div>
  <div class="card">
    <h2><a href="eee.jsp"><button class="login-button">Electrical and Electronics Engineering - EEE</button></a></h2>
    <p>67 Members</p>
  </div>
  <div class="card">
    <h2><a href="cic.jsp"><button class="login-button">Computer Science and Engineering in Cyber Security - CIC</button></a></h2>
    <p>60 Members</p>
  </div>
  <div class="card">
    <h2><a href="iot.jsp"><button class="login-button">Computer Science and Engineering in IOT</button></a></h2>
    <p>50 Members</p>
  </div>
  <div class="card">
    <h2><a href="aids.jsp"><button class="login-button">Artificial Intelligance in Data Science - AIDS</button></a></h2>
    <p>100 Members</p>
  </div>
  <div class="card">
    <h2><a href="aiml.jsp"><button class="login-button">Artificial Intelligance in Machine Learning - AIML</button></a></h2>
    <p>50 Members</p>
  </div>
</div>
