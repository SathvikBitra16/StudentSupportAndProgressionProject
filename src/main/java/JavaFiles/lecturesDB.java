	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if(rs.next()) {
				...
				out.println("<html><head><style>table{position: relative;left:60px;width: 95%;}p{position: relative;left:540px;top: 0px;font-size: 30px;}");
				...
				out.println("<th>Programme Name</th>");
				...
				while(rs.next()) {
					...
					out.println("<tr>");
					out.println("<td>"+i+"</td>");
					out.println("<td>"+rs.getString("FACULTYNAME")+"</td>");
					out.println("<td>"+rs.getString("PROGRAMMENAME")+"</td>");
